...
function carregarSelects() {
    fetch('http://localhost:3000/api/autores')
        ...
        .then(data => {
            ...
            if (!selectAutor) return console.warn('Elemento #livro-autor_id não encontrado');
    ...
    fetch('http://localhost:3000/api/categorias')
        ...
        .then(data => {
            ...
            if (!selectCategoria) return console.warn('Elemento #livro-categoria_id não encontrado');
