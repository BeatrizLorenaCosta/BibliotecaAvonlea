...
function carregarSelects() {
    fetch('http://localhost:3000/api/autores')
        ...
        .then(data => {
            ...
            data.forEach(autor => {
                ...
                option.value = autor.id_autor; // CORRETO
                option.textContent = autor.nome_autor; // CORRETO
    ...
    fetch('http://localhost:3000/api/categorias')
        ...
        .then(data => {
            ...
            data.forEach(cat => {
                const option = document.createElement('option');
                option.value = cat.id_categoria; // CORRETO
                option.textContent = cat.nome_categoria; // CORRETO
