document.addEventListener('DOMContentLoaded', () => {
    ...
    preencherSelect('livro-autor_id', autores, 'id_autor', 'nome_autor'); // Carrega autores nos selects
    preencherSelect('livro-categoria_id', categorias, 'id_categoria', 'nome_categoria'); // Carrega categorias nos selects
});
