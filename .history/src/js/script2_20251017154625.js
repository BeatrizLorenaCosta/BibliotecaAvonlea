...
function preencherTabela(tipo, dados) {
    ...
    dados.forEach(item => {
        ...
        if (tipo === 'livros') {
            const autor = autores.find(a => a.id_autor === item.autor_id); // CORRIGIDO
            const categoria = categorias.find(c => c.id_categoria === item.categoria_id); // CORRIGIDO
            console.log("nome do autor:", autor.nome_autor);
            console.log("nome da categoria:", categoria.nome_categoria);
            ...
            tr.innerHTML = `
                ...
                <td class="actions">
                    <button class="edit" onclick="editar('${tipo}', ${item.id_autor})">Editar</button>
                    <button class="delete" onclick="deletar('${tipo}', ${item.id_autor})">Excluir</button>
                </td>
            `;
        } else if (tipo === 'categorias') {
            tr.innerHTML = `
                ...
                <td class="actions">
                    <button class="edit" onclick="editar('${tipo}', ${item.id_categoria})">Editar</button>
                    <button class="delete" onclick="deletar('${tipo}', ${item.id_categoria})">Excluir</button>
                </td>
            `;
        } else  {
