    ...
    fetch(`http://localhost:3000/api/${tipo}`)
        ...
        .then(dados => {
            if (tipo === 'autores') {
                ...
                // se a section autores estiver visível
                if (document.getElementById('section-autores').classList.contains('hidden')) {
                    document.getElementById('section-autores').classList.remove('hidden');
                }
