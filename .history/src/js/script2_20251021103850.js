...
document.addEventListener('DOMContentLoaded', async () => {
    // Carregar os dados sem preencher tabelas ainda
    await Promise.all([
    ...
    // Depois preencher todas as tabelas, agora que todas as dependências estão carregadas
    ['autores', 'categorias', 'livros', 'utilizadores', 'emprestimos', 'avaliacoes']
        .forEach(tipo => preencherTabela(tipo, window[tipo]));
