...
app.put('/api/autores/:id', (req, res) => {
    const { nome, nacionalidade, data_nascimento } = req.body;
    db.query('UPDATE autores SET nome_autor=?, nacionalidade=?, data_nascimento=? WHERE id=?',
...
app.put('/api/categorias/:id', (req, res) => {
    const { nome, descricao } = req.body;
    db.query('UPDATE categorias SET nome_categoria=?, descricao=? WHERE id=?',
...
app.delete('/api/categorias/:id', (req, res) => {
    db.query('DELETE FROM categorias WHERE id_categ=?', [req.params.id],
