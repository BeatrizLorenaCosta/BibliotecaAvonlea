...
app.get('/api/livros', (req, res) => {
    db.query('SELECT l.titulo, a.nome_autor, c.nome_categoria FROM livros l JOIN autores a ON l.autor_id = a.id_autor JOIN categorias c ON l.categoria_id = c.id_categoria', (err, results) => {
