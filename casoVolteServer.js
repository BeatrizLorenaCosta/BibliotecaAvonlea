...
app.get('/reservas', (req, res) => {
    // Supondo que o ID do usuário está disponível na sessão ou token
    const utilizadorId = req.session.utilizadorId; // ou req.user.id, dependendo da sua autenticação
